...
public class GetminApp {
	...
	public static void main(String[] args) {
		...
		n = s.nextInt();
		m = s.nextInt();
		System.out.println("최소값은 " + getMin(n, m) + " 입니다.");

		double o, p;
		System.out.print("두 개의 실수를 입력하세요 : ");
		o = s.nextDouble();
		p = s.nextDouble();
		System.out.println("최소값은 " + getMin(o, p) + " 입니다.");

		String t1=null, t2=null;
		System.out.print("두 개의 문자열을 입력하세요 : ");
		t1 = s.next();
		t2 = s.next();
		System.out.println("최소값은 " + getMin(t1, t2) + " 입니다.");

		int arr[] = {1, 1, 1, 1, 1};
		System.out.print("정수 배열의 5개 원소 : ");
		for(int i = 0; i < ARRAY_SIZE; i++)
			arr[i] = s.nextInt();
		System.out.println("최소값은 " + getMin(arr) + "입니다.");
