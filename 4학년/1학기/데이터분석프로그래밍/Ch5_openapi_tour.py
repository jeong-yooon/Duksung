...
ServiceKey="nq%2Fq4wc9ixxo%2Bkc2gpyllrM6Gx21gS5iW8TlZ%2FgznA%2Bd9y5BDtoTWNcz4d6VBmplyAhPNHIKYBTLc7h3M0Ye4A%3D%3D"
...
def main():
    ...
    if (natName=='') : #URL 요청은 성공하였지만, 데이터 제공이 안된 경우
        ...
        result_df1 = pd.DataFrame(jsonResult)
...
if __name__ == '__main__':
    ...
    #api_Key="nq%2Fq4wc9ixxo%2Bkc2gpyllrM6Gx21gS5iW8TlZ%2FgznA%2Bd9y5BDtoTWNcz4d6VBmplyAhPNHIKYBTLc7h3M0Ye4A%3D%3D"

    api_Key = 'nq/q4wc9ixxo+kc2gpyllrM6Gx21gS5iW8TlZ/gznA+d9y5BDtoTWNcz4d6VBmplyAhPNHIKYBTLc7h3M0Ye4A=='

    #api_key_decode = requests.utils.unquote(api_Key)

    url = 'http://openapi.tour.go.kr/openapi/service/EdrcntTourismStatsService/getEdrcntTourismStatsList'
    params = {'serviceKey': api_Key, 'YM': '201201', 'NAT_CD': '112', 'ED_CD': 'E'}
